...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: "file_path", type: "string", nullable: true, example: "/proposals/1/download"),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: "comment", type: "string", nullable: true, example: "Great proposal!"),
